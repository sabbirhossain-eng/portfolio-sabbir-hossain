    ...
    <div className="w-full h-full">
      <div className="mb-10 rounded-lg bg-card-dark p-10 hover:border hover:border-primary">
        ...
        <div className="text-in-dark mt-4 mb-8">
          <h2 className="text-3xl font-semibold text-primary mb-4">{title2}</h2>
          <p className="text-lg ">
        ...
        <div className="flex flex-col lg:flex-row lg:justify-between mb-4 mt-auto mx-auto gap-4">
          <div>
            <Link to={liveLink} target="_blank">
              <button className=" bt-sm px-1 py-1 text-sm hover:text-black  justify-center hover:bg-primary  rounded-md bg-card-dark text-in-dark hover:scale-125 transition duration-500 border-2 border-primary">
                <span>|</span>&nbsp;&nbsp;
                <span>Live Link</span>
              </button>
            </Link>
